...
describe "sms_notifications/edit" do
  before(:each) do
  ...
  it "renders the edit sms_notification form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", sms_notification_path(@sms_notification), "post" do
