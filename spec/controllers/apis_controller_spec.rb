  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved api as @api" do
        ...
        post :create, {:api => { "ip" => "invalid value" }}, valid_session
        assigns(:api).should be_a_new(Api)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested api" do
        ...
        Api.any_instance.should_receive(:update).with({ "ip" => "MyString" })
        put :update, {:id => api.to_param, :api => { "ip" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the api as @api" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Api.any_instance.stub(:save).and_return(false)
        put :update, {:id => api.to_param, :api => { "ip" => "invalid value" }}, valid_session
        assigns(:api).should eq(api)
      end
