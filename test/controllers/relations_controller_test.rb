...
class RelationsControllerTest < ActionController::TestCase
  ...
  test "should create relation" do
    assert_difference('Relation.count') do
      post :create, relation: { event_entry: @relation.event_entry, event_exit: @relation.event_exit, event_post: @relation.event_post, user_from: @relation.user_from, user_to: @relation.user_to }
    end
  ...
  test "should update relation" do
    patch :update, id: @relation, relation: { event_entry: @relation.event_entry, event_exit: @relation.event_exit, event_post: @relation.event_post, user_from: @relation.user_from, user_to: @relation.user_to }
    assert_redirected_to relation_path(assigns(:relation))
  end
